...
tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab8, tab9 = st.tabs(
    ["About Me", "Resume", "Projects", "Hobbies", "Tech Stack", "Testimonials","Organizations", "More", "Project1"]
)
...
with tab8:
    ...
    # === TAB 9: PROJECT – AI-Powered Business Risk Intelligence Dashboard ===
import pandas as pd
import numpy as np
...
with tab9:
    ...
    st.write("Upload a transaction dataset or use the sample to detect anomalies.")
    ...
    # Model selection
    model_choice = st.selectbox("Select anomaly detection model:", ["Isolation Forest", "Local Outlier Factor"])
    ...
    # Explainability with SHAP (works only with Isolation Forest here)
    if model_choice == "Isolation Forest":
